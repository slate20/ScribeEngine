...
from v1_engine.core import GameEngine
...
def index():
    ...
    return render_template('v1_engine/templates/base.html',
...
def get_save_modal():
    ...
    try:
        ...
        if hasattr(game_engine, 'is_browser_storage') and game_engine.is_browser_storage:
            ...
            modal_html = render_template('v1_engine/templates/_fragments/_htmx_save_modal.html', saves={}, config=safe_config, project_name=os.path.basename(game_engine.project_path))
            ...
            return render_template('v1_engine/templates/_fragments/_htmx_save_modal.html', saves=saves, config=safe_config, project_name=os.path.basename(game_engine.project_path))
    except Exception as e:
...
def get_load_modal():
    ...
    try:
        ...
        if hasattr(game_engine, 'is_browser_storage') and game_engine.is_browser_storage:
            ...
            modal_html = render_template('v1_engine/templates/_fragments/_htmx_load_modal.html', saves={}, populated_saves={}, config=safe_config, project_name=os.path.basename(game_engine.project_path))
            ...
            return render_template('v1_engine/templates/_fragments/_htmx_load_modal.html',
...
def select_save_slot():
    ...
    try:
        ...
        return render_template('v1_engine/templates/_fragments/_save_details.html',
                             slot=slot,
...
def select_load_slot():
    ...
    try:
        ...
        if hasattr(game_engine, 'is_browser_storage') and game_engine.is_browser_storage:
            ...
            return render_template('v1_engine/templates/_fragments/_load_details.html',
...
def new_file_modal(project_name, category):
    ...
    return render_template('ide/templates/v1_editor/_htmx_new_file_modal.html',
...
def rename_file_modal(project_name, file_path):
    ...
    return render_template('ide/templates/v1_editor/_htmx_rename_file_modal.html',
                         project_name=project_name,
...
def new_folder_modal(project_name):
    ...
    return render_template('ide/templates/v1_editor/_htmx_new_folder_modal.html', project_name=project_name)
...
@app.route('/gui')
def gui_launcher():
    return render_template('ide/templates/ide_base/launcher.html', project_root=config_manager.get_project_root())

@app.route('/api/startup-screen')
def get_startup_screen():
    return render_template('ide/templates/ide_base/_startup_screen.html')
...
def list_files(project_name):
    ...
    return render_template('ide/templates/v1_editor/_file_list.html',
...
def settings_panel():
    ...
    return render_template('ide/templates/ide_base/_settings_panel.html', project_root=project_root)
...
def get_project_settings(project_name):
    ...
    return render_template('ide/templates/v1_editor/_project_settings.html', project_name=project_name, config=config)
...
def get_preview_panel():
    return render_template('ide/templates/v1_editor/_preview_panel.html')
