...
# --- Flask App Setup ---
# The 'game' directory is expected to be relative to app.py
GAME_PROJECT_PATH = os.path.join(os.path.dirname(__file__), 'game')
...
# Initialize game engine (now always points to the local 'game' directory)
