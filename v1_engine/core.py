...
from v1_engine.parser import GameParser
from v1_engine.executor import SafeExecutor
from v1_engine.state import StateManager
from shared.storage.storage import JSONStorage
from shared.storage.browser_storage import BrowserStorage
    ...
    def _auto_restore_object(self, data):
        ...
        if isinstance(data, dict):
            ...
            if data.get('__class_name__') == 'DefaultPlayer':
                from v1_engine.state import DefaultPlayer
