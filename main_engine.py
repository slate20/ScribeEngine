...
from project_templates import create_webapp_project
...
# --- Helper function - delegates to project_templates module ---
def create_new_project(project_name: str, project_root_dir: str):
    ...
    return create_webapp_project(project_name, project_root_dir)
